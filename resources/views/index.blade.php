...
<!-- Navigation-->
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="{{ asset('img/logo.png') }}" style=”float:left;
                    width="55";height="55"” />RS FATIMAH</a>
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container d-flex align-items-center flex-column">
            ...
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">RS FATIMAH PALEMBANG</h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">PALEMBANG</p>
        </div>
    </header>
    <!--------------------------------------------------------Bagian Isi Konten----------------------------------------------------------------------------------->
            ...
            <div class="row">
                ...
                <div class="col-lg-4 me-auto">
                    <p class="lead">Anda bisa mendaftar secara online tanpa perlu mengantri atau
                        langsung datang ke Rumah Sakit <a class="btn btn-outline-light" href="/antrian-pasien">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p class="lead mb-0">
                        Jl Kolonel H. Barlian, Suka Bangun
                        <br />
                        Kec. Sukarami, Kota Palembang, Sumatera Selatan 30151
                    </p>
                </div>
                <!-- Footer Social Icons-->
                <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <!-- Footer About Text-->
                <div class="col-lg-4">
                    <h4 class="text-uppercase mb-4">Tentang Rumah Sakit Fatimah</h4>
                    <p class="lead mb-0">
                         {{ env('APP_NAME') }} 
                    </p>
                </div>
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>Powered by &copy;  {{ env('APP_NAME') }} 2025</small></div>
    </div>
    <!-- Portfolio Modals-->
